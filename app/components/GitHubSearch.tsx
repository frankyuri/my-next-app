...
export default function GitHubSearch() {
  ...
  return (
    <div className="p-6 border-2 border-blue-500 rounded-lg m-4 bg-white dark:bg-zinc-900">
      <h2 className="text-2xl font-bold mb-4 text-gray-800 dark:text-white">🔍 GitHub 用戶搜尋</h2>
            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-3 gap-4 mb-3">
                <div className="text-center p-2 bg-white dark:bg-zinc-800 rounded">
                  ...
                  <div className="text-xs text-gray-600 dark:text-gray-400">倉庫</div>
                </div>
                <div className="text-center p-2 bg-white dark:bg-zinc-800 rounded">
                  <div className="text-2xl font-bold text-green-600 dark:text-green-400">
                    {user.followers}
                  </div>
                  <div className="text-xs text-gray-600 dark:text-gray-400">粉絲</div>
                </div>
                <div className="text-center p-2 bg-white dark:bg-zinc-800 rounded">
                  <div className="text-2xl font-bold text-purple-600 dark:text-purple-400">
                    {user.following}
                  </div>
                  <div className="text-xs text-gray-600 dark:text-gray-400">關注</div>
                </div>
              </div>
              <a
                href={user.html_url}
